...
function resetProgress() {
  const itemLabel = getUnitLabel(true).toLowerCase();
  const confirmed = window.confirm(
    `Are you sure you want to reset your progress? This will clear your completed ${itemLabel} and return you to the beginning.`
  );
